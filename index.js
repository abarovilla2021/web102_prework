...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length}.
Currently, ${numUnfundedGames} ${numUnfundedGames !== 1 ? "games" : "game"} remains unfunded. We
...
// set the inner HTML to the display string
...
// update the DOM with the top two games
